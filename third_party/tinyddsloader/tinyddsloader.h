...
private:
    void GetImageInfo(
        uint32_t w, uint32_t h, DXGIFormat fmt, uint32_t* outNumBytes, uint32_t* outRowBytes, uint32_t* outNumRows);
...
DDSFile::DXGIFormat DDSFile::GetDXGIFormat(const PixelFormat& pf)
{
    if (pf.m_flags & uint32_t(PixelFormatFlagBits::RGB))
    {
        ...
        {
        case 32:
            if (pf.m_RBitMask == 0x000000ff && pf.m_GBitMask == 0x0000ff00 && pf.m_BBitMask == 0x00ff0000 &&
                pf.m_ABitMask == 0xff000000)
            {
                return DXGIFormat::R8G8B8A8_UNorm;
            }
            if (pf.m_RBitMask == 0x00ff0000 && pf.m_GBitMask == 0x0000ff00 && pf.m_BBitMask == 0x000000ff &&
                pf.m_ABitMask == 0xff000000)
            {
            ...
            if (pf.m_RBitMask == 0x0000ffff && pf.m_GBitMask == 0xffff0000 && pf.m_BBitMask == 0x00000000 &&
                pf.m_ABitMask == 0x00000000)
            {
                return DXGIFormat::R16G16_UNorm;
            }

            if (pf.m_RBitMask == 0xffffffff && pf.m_GBitMask == 0x00000000 && pf.m_BBitMask == 0x00000000 &&
                pf.m_ABitMask == 0x00000000)
            {
        ...
        case 24:
            break;
        case 16:
            if (pf.m_RBitMask == 0x7c00 && pf.m_GBitMask == 0x03e0 && pf.m_BBitMask == 0x001f &&
                pf.m_ABitMask == 0x8000)
            {
                return DXGIFormat::B5G5R5A1_UNorm;
            }
            if (pf.m_RBitMask == 0xf800 && pf.m_GBitMask == 0x07e0 && pf.m_BBitMask == 0x001f &&
                pf.m_ABitMask == 0x0000)
            {
                return DXGIFormat::B5G6R5_UNorm;
            }

            if (pf.m_RBitMask == 0x0f00 && pf.m_GBitMask == 0x00f0 && pf.m_BBitMask == 0x000f &&
                pf.m_ABitMask == 0xf000)
            {
    ...
    else if (pf.m_flags & uint32_t(PixelFormatFlagBits::Luminance))
    {
        if (8 == pf.m_bitCount)
        {
            if (pf.m_RBitMask == 0x000000ff && pf.m_GBitMask == 0x00000000 && pf.m_BBitMask == 0x00000000 &&
                pf.m_ABitMask == 0x00000000)
            {
                return DXGIFormat::R8_UNorm;
            }
            if (pf.m_RBitMask == 0x000000ff && pf.m_GBitMask == 0x0000ff00 && pf.m_BBitMask == 0x00000000 &&
                pf.m_ABitMask == 0x00000000)
            {
        ...
        if (16 == pf.m_bitCount)
        {
            if (pf.m_RBitMask == 0x0000ffff && pf.m_GBitMask == 0x00000000 && pf.m_BBitMask == 0x00000000 &&
                pf.m_ABitMask == 0x00000000)
            {
    ...
    else if (pf.m_flags & uint32_t(PixelFormatFlagBits::BumpDUDV))
    {
        if (16 == pf.m_bitCount)
        {
            if (pf.m_RBitMask == 0x00ff && pf.m_GBitMask == 0xff00 && pf.m_BBitMask == 0x0000 &&
                pf.m_ABitMask == 0x0000)
            {
...
Result DDSFile::Load(std::vector<uint8_t>&& dds)
{
    ...
    auto header = reinterpret_cast<const Header*>(dds.data() + sizeof(uint32_t));
    ...
    if ((header->m_pixelFormat.m_flags & uint32_t(PixelFormatFlagBits::FourCC)) &&
    ...
    ptrdiff_t offset = sizeof(uint32_t) + sizeof(Header) + (dxt10Header ? sizeof(HeaderDXT10) : 0);
    ...
    if (dxt10Header)
    {
        auto dxt10Header = reinterpret_cast<const HeaderDXT10*>(reinterpret_cast<const char*>(header) + sizeof(Header));
        ...
        case TextureDimension::Texture1D:
            if ((header->m_flags & uint32_t(HeaderFlagBits::Height) && (m_height != 1)))
            {
                return Result::ErrorInvalidData;
            }
            m_height = m_depth = 1;
        ...
        case TextureDimension::Texture2D:
            if (dxt10Header->m_miscFlag & uint32_t(DXT10MiscFlagBits::TextureCube))
            {
                m_arraySize *= 6;
                m_isCubemap = true;
            }
    ...
    else
    {
        ...
        {
            auto caps2 = header->m_caps2 & uint32_t(HeaderCaps2FlagBits::CubemapAllFaces);
            if (caps2)
            {
...
bool DDSFile::FlipImage(ImageData& imageData)
{
    for (uint32_t y = 0; y < imageData.m_height / 2; y++)
    {
        ...
        auto line1 = ( uint8_t* ) imageData.m_mem + (imageData.m_height - y - 1) * imageData.m_memPitch;
...
{
    if (DXGIFormat::BC1_Typeless == m_format || DXGIFormat::BC1_UNorm == m_format ||
        DXGIFormat::BC1_UNorm_SRGB == m_format)
    {
        ...
        DXGIFormat::BC2_Typeless == m_format || DXGIFormat::BC2_UNorm == m_format ||
        DXGIFormat::BC2_UNorm_SRGB == m_format)
    {
        ...
        DXGIFormat::BC3_Typeless == m_format || DXGIFormat::BC3_UNorm == m_format ||
        DXGIFormat::BC3_UNorm_SRGB == m_format)
    {
        ...
        DXGIFormat::BC4_Typeless == m_format || DXGIFormat::BC4_UNorm == m_format || DXGIFormat::BC4_SNorm == m_format)
    {
        FlipCompressedImageBC4(imageData);
        return true;
    }
    else if (
        DXGIFormat::BC5_Typeless == m_format || DXGIFormat::BC5_UNorm == m_format || DXGIFormat::BC5_SNorm == m_format)
    {
...
void DDSFile::FlipCompressedImageBC1(ImageData& imageData)
{
    ...
    else
    {
        ...
        {
            auto blocks0 = ( BC1Block* ) (( uint8_t* ) imageData.m_mem + imageData.m_memPitch * y);
            auto blocks1 = ( BC1Block* ) (( uint8_t* ) imageData.m_mem + imageData.m_memPitch * (numYBlocks - y - 1));
            for (uint32_t x = 0; x < numXBlocks; x++)
            {
...
void DDSFile::FlipCompressedImageBC2(ImageData& imageData)
{
    ...
    else
    {
        for (uint32_t y = 0; y < (numYBlocks + 1) / 2; y++)
        {
            auto blocks0 = ( BC2Block* ) (( uint8_t* ) imageData.m_mem + imageData.m_memPitch * y);
            auto blocks1 = ( BC2Block* ) (( uint8_t* ) imageData.m_mem + imageData.m_memPitch * (numYBlocks - y - 1));
            for (uint32_t x = 0; x < numXBlocks; x++)
            {
                auto block0 = blocks0 + x;
                auto block1 = blocks1 + x;
...
void DDSFile::FlipCompressedImageBC3(ImageData& imageData)
{
    ...
    else
    {
        for (uint32_t y = 0; y < (numYBlocks + 1) / 2; y++)
        {
            auto blocks0 = ( BC3Block* ) (( uint8_t* ) imageData.m_mem + imageData.m_memPitch * y);
            auto blocks1 = ( BC3Block* ) (( uint8_t* ) imageData.m_mem + imageData.m_memPitch * (numYBlocks - y - 1));
            for (uint32_t x = 0; x < numXBlocks; x++)
            {
                auto block0 = blocks0 + x;
                auto block1 = blocks1 + x;
...
void DDSFile::FlipCompressedImageBC4(ImageData& imageData)
{
    ...
    else
    {
        for (uint32_t y = 0; y < (numYBlocks + 1) / 2; y++)
        {
            auto blocks0 = ( BC4Block* ) (( uint8_t* ) imageData.m_mem + imageData.m_memPitch * y);
            auto blocks1 = ( BC4Block* ) (( uint8_t* ) imageData.m_mem + imageData.m_memPitch * (numYBlocks - y - 1));
            for (uint32_t x = 0; x < numXBlocks; x++)
            {
                auto block0 = blocks0 + x;
                auto block1 = blocks1 + x;
...
void DDSFile::FlipCompressedImageBC5(ImageData& imageData)
{
    ...
    else
    {
        for (uint32_t y = 0; y < (numYBlocks + 1) / 2; y++)
        {
            auto blocks0 = ( BC5Block* ) (( uint8_t* ) imageData.m_mem + imageData.m_memPitch * y);
            auto blocks1 = ( BC5Block* ) (( uint8_t* ) imageData.m_mem + imageData.m_memPitch * (numYBlocks - y - 1));
            for (uint32_t x = 0; x < numXBlocks; x++)
            {
                auto block0 = blocks0 + x;
                auto block1 = blocks1 + x;
