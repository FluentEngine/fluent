...
GraphicContext::GraphicContext( const GraphicContextDesc& desc )
{
    ...
    create_command_buffers( m_device,
                            m_command_pool,
                            FRAME_COUNT,
                            m_command_buffers );
...
GraphicContext::~GraphicContext()
{
    ...
    destroy_command_buffers( m_device,
                             m_command_pool,
                             FRAME_COUNT,
                             m_command_buffers );
...
void GraphicContext::shutdown() { delete graphic_context; }
...
GraphicContext* GraphicContext::get() { return graphic_context; }
} // namespace fluent
