...
TIF_CONSTEXPR inline uint64_t
TinyImageFormat_Code( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
...
TIF_CONSTEXPR inline bool
TinyImageFormat_IsDepthOnly( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
...
TIF_CONSTEXPR inline bool
TinyImageFormat_IsStencilOnly( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
...
TIF_CONSTEXPR inline bool
TinyImageFormat_IsDepthAndStencil( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
...
TIF_CONSTEXPR inline bool
TinyImageFormat_IsCLUT( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
...
TIF_CONSTEXPR inline bool
TinyImageFormat_IsFloat( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
...
TIF_CONSTEXPR inline bool
TinyImageFormat_IsNormalised( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
...
TIF_CONSTEXPR inline bool
TinyImageFormat_IsSigned( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
	case TinyImageFormat_R8_SNORM: return true;
...
TIF_CONSTEXPR inline bool
TinyImageFormat_IsSRGB( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
	case TinyImageFormat_R8_SRGB: return true;
...
TIF_CONSTEXPR inline bool
TinyImageFormat_IsCompressed( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
	case TinyImageFormat_DXBC1_RGB_UNORM: return true;
...
TIF_CONSTEXPR inline bool
TinyImageFormat_IsHomogenous( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
...
TinyImageFormat_WidthOfBlock( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
...
TIF_CONSTEXPR inline uint32_t
TinyImageFormat_HeightOfBlock( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
	case TinyImageFormat_UNDEFINED: return 0;
...
TIF_CONSTEXPR inline uint32_t
TinyImageFormat_DepthOfBlock( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
	case TinyImageFormat_UNDEFINED: return 0;
...
TIF_CONSTEXPR inline uint32_t
TinyImageFormat_ChannelCount( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
	case TinyImageFormat_UNDEFINED: return 0;
...
TIF_CONSTEXPR inline uint32_t
TinyImageFormat_ChannelBitWidthAtPhysical( TinyImageFormat const fmt,
...
TIF_CONSTEXPR inline double
TinyImageFormat_MinAtPhysical( TinyImageFormat const fmt,
                               uint32_t const        channel )
{
	if ( TinyImageFormat_IsHomogenous( fmt ) || channel == 0 )
	{
...
TIF_CONSTEXPR inline double
TinyImageFormat_MaxAtPhysical( TinyImageFormat const fmt,
                               uint32_t const        channel )
{
	if ( TinyImageFormat_IsHomogenous( fmt ) || channel == 0 )
	{
...
TIF_CONSTEXPR inline TinyImageFormat_LogicalChannel
TinyImageFormat_PhysicalChannelToLogical( TinyImageFormat const fmt,
                                          int8_t const          channel )
{
...
TIF_CONSTEXPR inline int8_t
TinyImageFormat_LogicalChannelToPhysical(
    TinyImageFormat const                fmt,
    TinyImageFormat_LogicalChannel const channel )
{
...
TIF_CONSTEXPR inline char const *const
TinyImageFormat_Name( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
...
inline TinyImageFormat
TinyImageFormat_FromName( char const *p )
{
...
// Helpers
TIF_CONSTEXPR inline uint32_t
TinyImageFormat_PixelCountOfBlock( TinyImageFormat const fmt )
{
	return TinyImageFormat_WidthOfBlock( fmt ) *
	       TinyImageFormat_HeightOfBlock( fmt ) *
	       TinyImageFormat_DepthOfBlock( fmt );
}

TIF_CONSTEXPR inline double
TinyImageFormat_Min( TinyImageFormat const                fmt,
                     TinyImageFormat_LogicalChannel const channel )
{
	return TinyImageFormat_MinAtPhysical(
	    fmt,
	    TinyImageFormat_LogicalChannelToPhysical( fmt, channel ) );
}

TIF_CONSTEXPR inline double
TinyImageFormat_Max( TinyImageFormat const                fmt,
                     TinyImageFormat_LogicalChannel const channel )
{
	return TinyImageFormat_MaxAtPhysical(
	    fmt,
	    TinyImageFormat_LogicalChannelToPhysical( fmt, channel ) );
}

TIF_CONSTEXPR inline uint32_t
TinyImageFormat_ChannelBitWidth( TinyImageFormat const                fmt,
                                 TinyImageFormat_LogicalChannel const channel )
{
	return TinyImageFormat_ChannelBitWidthAtPhysical(
	    fmt,
	    TinyImageFormat_LogicalChannelToPhysical( fmt, channel ) );
}
...
inline void
TinyImageFormat_SharedE5B9G9R9UFloatToFloats( uint32_t v, float out[ 4 ] )
{
...
inline float
TinyImageFormat_HalfAsUintToFloat( uint16_t h_ )
{
...
inline float
TinyImageFormat_BFloatAsUintToFloat( uint16_t h_ )
{
	union
	{
		struct
...
inline float
TinyImageFormat_UFloat6AsUintToFloat( uint16_t Value )
{
	// https://github.com/microsoft/DirectXMath/blob/ecfb4754400dac581c2eeb6e849617cf5d210426/Inc/DirectXPackedVector.h
...
inline float
TinyImageFormat_UFloat7AsUintToFloat( uint16_t Value )
{
	// https://github.com/microsoft/DirectXMath/blob/ecfb4754400dac581c2eeb6e849617cf5d210426/Inc/DirectXPackedVector.h
...
inline float
TinyImageFormat_UFloat10AsUintToFloat( uint16_t v )
{
	// https://github.com/microsoft/DirectXMath/blob/ecfb4754400dac581c2eeb6e849617cf5d210426/Inc/DirectXPackedVector.h
	union
	{
...
inline float
TinyImageFormat_UFloat11AsUintToFloat( uint16_t v )
{
	// https://github.com/microsoft/DirectXMath/blob/ecfb4754400dac581c2eeb6e849617cf5d210426/Inc/DirectXPackedVector.h
	union
	{
...
TIF_CONSTEXPR inline float
TinyImageFormat_LookupSRGB( uint8_t lookup )
{
	switch ( lookup )
	{
...
TIF_CONSTEXPR inline bool
TinyImageFormat_CanDecodeLogicalPixelsF( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
	case TinyImageFormat_R1_UNORM: return true;
...
TIF_CONSTEXPR inline bool
TinyImageFormat_DecodeLogicalPixelsF( TinyImageFormat const        fmt,
                                      ...
                                      float                       *out )
{
	...
	case TinyImageFormat_R1_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			in->pixel =
			    ( void const * ) ( ( ( uint8_t const * ) in->pixel ) + 1 );
			out += 32;
		}
		return true;
	case TinyImageFormat_R2_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint8_t val = *( ( uint8_t const * ) in->pixel );
			out[ 0 ] =
			    ( ( float ) ( ( val >> 0 ) & 0x3 ) ) * ( ( float ) 0.33333333 );
			out[ 1 ] = ( float ) 0.00000000;
			out[ 2 ] = ( float ) 0.00000000;
			out[ 3 ] = ( float ) 1.00000000;
			out[ 4 ] =
			    ( ( float ) ( ( val >> 2 ) & 0x3 ) ) * ( ( float ) 0.33333333 );
			out[ 5 ] = ( float ) 0.00000000;
			out[ 6 ] = ( float ) 0.00000000;
			out[ 7 ] = ( float ) 1.00000000;
			out[ 8 ] =
			    ( ( float ) ( ( val >> 4 ) & 0x3 ) ) * ( ( float ) 0.33333333 );
			out[ 9 ]  = ( float ) 0.00000000;
			out[ 10 ] = ( float ) 0.00000000;
			out[ 11 ] = ( float ) 1.00000000;
			out[ 12 ] =
			    ( ( float ) ( ( val >> 6 ) & 0x3 ) ) * ( ( float ) 0.33333333 );
			out[ 13 ] = ( float ) 0.00000000;
			out[ 14 ] = ( float ) 0.00000000;
			out[ 15 ] = ( float ) 1.00000000;
			in->pixel =
	...
	case TinyImageFormat_R4_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint8_t val = *( ( uint8_t const * ) in->pixel );
			out[ 0 ] =
			    ( ( float ) ( ( val >> 0 ) & 0xf ) ) * ( ( float ) 0.06666667 );
			out[ 1 ] = ( float ) 0.00000000;
			out[ 2 ] = ( float ) 0.00000000;
			out[ 3 ] = ( float ) 1.00000000;
			out[ 4 ] =
			    ( ( float ) ( ( val >> 4 ) & 0xf ) ) * ( ( float ) 0.06666667 );
			out[ 5 ] = ( float ) 0.00000000;
			out[ 6 ] = ( float ) 0.00000000;
			out[ 7 ] = ( float ) 1.00000000;
			in->pixel =
	...
	case TinyImageFormat_A8_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			out[ 3 ] = ( ( float ) ( ( uint8_t const * ) in->pixel )[ 0 ] ) *
			           ( float ) 0.00392157;
	...
	case TinyImageFormat_R8_SNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int8_t const * ) in->pixel ) + 1 );
		}
		return true;
	...
	case TinyImageFormat_R8_SRGB:
		for ( uint32_t w = 0; w < width; ++w )
		{
			out[ 0 ] = ( float ) TinyImageFormat_LookupSRGB(
			    ( ( uint8_t const * ) in->pixel )[ 0 ] );
			out[ 1 ] = ( float ) 0.00000000;
			out[ 2 ] = ( float ) 0.00000000;
			out[ 3 ] = ( float ) 1.00000000;
			out += 4;
	...
	case TinyImageFormat_B2G3R3_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out[ 2 ] =
			    ( ( float ) ( ( val >> 0 ) & 0x3 ) ) * ( ( float ) 0.33333333 );
			out[ 1 ] =
			    ( ( float ) ( ( val >> 2 ) & 0x7 ) ) * ( ( float ) 0.14285714 );
			out[ 0 ] =
			    ( ( float ) ( ( val >> 5 ) & 0x7 ) ) * ( ( float ) 0.14285714 );
			out[ 3 ] = ( float ) 1.00000000;
			in->pixel =
			    ( void const * ) ( ( ( uint8_t const * ) in->pixel ) + 1 );
			out += 4;
	...
	case TinyImageFormat_R4G4B4A4_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out[ 1 ] =
			    ( ( float ) ( ( val >> 4 ) & 0xf ) ) * ( ( float ) 0.06666667 );
			out[ 2 ] =
			    ( ( float ) ( ( val >> 8 ) & 0xf ) ) * ( ( float ) 0.06666667 );
			out[ 3 ] = ( ( float ) ( ( val >> 12 ) & 0xf ) ) *
			           ( ( float ) 0.06666667 );
			in->pixel =
			    ( void const * ) ( ( ( uint16_t const * ) in->pixel ) + 1 );
			out += 4;
		}
		return true;
	...
	case TinyImageFormat_R5G6B5_UNORM:
		...
		{
			uint16_t val = *( ( uint16_t const * ) in->pixel );
			out[ 0 ]     = ( ( float ) ( ( val >> 0 ) & 0x1f ) ) *
			           ( ( float ) 0.03225806 );
			out[ 1 ] = ( ( float ) ( ( val >> 5 ) & 0x3f ) ) *
			           ( ( float ) 0.01587302 );
			out[ 2 ] = ( ( float ) ( ( val >> 11 ) & 0x1f ) ) *
			           ( ( float ) 0.03225806 );
			out[ 3 ] = ( float ) 1.00000000;
			in->pixel =
			    ( void const * ) ( ( ( uint16_t const * ) in->pixel ) + 1 );
	...
	case TinyImageFormat_B5G6R5_UNORM:
		...
		{
			uint16_t val = *( ( uint16_t const * ) in->pixel );
			out[ 2 ]     = ( ( float ) ( ( val >> 0 ) & 0x1f ) ) *
			           ( ( float ) 0.03225806 );
			out[ 1 ] = ( ( float ) ( ( val >> 5 ) & 0x3f ) ) *
			           ( ( float ) 0.01587302 );
			out[ 0 ] = ( ( float ) ( ( val >> 11 ) & 0x1f ) ) *
			           ( ( float ) 0.03225806 );
			out[ 3 ] = ( float ) 1.00000000;
			in->pixel =
			    ( void const * ) ( ( ( uint16_t const * ) in->pixel ) + 1 );
	...
	case TinyImageFormat_R5G5B5A1_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out[ 0 ]     = ( ( float ) ( ( val >> 0 ) & 0x1f ) ) *
			           ( ( float ) 0.03225806 );
			out[ 1 ] = ( ( float ) ( ( val >> 5 ) & 0x1f ) ) *
			           ( ( float ) 0.03225806 );
			out[ 2 ] = ( ( float ) ( ( val >> 10 ) & 0x1f ) ) *
			           ( ( float ) 0.03225806 );
	...
	case TinyImageFormat_A1B5G5R5_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out[ 2 ]     = ( ( float ) ( ( val >> 1 ) & 0x1f ) ) *
			           ( ( float ) 0.03225806 );
			out[ 1 ] = ( ( float ) ( ( val >> 6 ) & 0x1f ) ) *
			           ( ( float ) 0.03225806 );
			out[ 0 ] = ( ( float ) ( ( val >> 11 ) & 0x1f ) ) *
			           ( ( float ) 0.03225806 );
			in->pixel =
	...
	case TinyImageFormat_R8G8_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint8_t const * ) in->pixel ) + 2 );
		}
		return true;
	case TinyImageFormat_R8G8_SNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int8_t const * ) in->pixel ) + 2 );
		}
		return true;
	case TinyImageFormat_G8R8_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			out[ 1 ] = ( ( float ) ( ( uint8_t const * ) in->pixel )[ 0 ] ) *
			           ( float ) 0.00392157;
			out[ 0 ] = ( ( float ) ( ( uint8_t const * ) in->pixel )[ 1 ] ) *
			           ( float ) 0.00392157;
			out[ 2 ] = ( float ) 0.00000000;
			out[ 3 ] = ( float ) 1.00000000;
			out += 4;
	...
	case TinyImageFormat_G8R8_SNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			out[ 1 ] = ( ( float ) ( ( int8_t const * ) in->pixel )[ 0 ] ) *
			           ( float ) 0.00787402;
			out[ 0 ] = ( ( float ) ( ( int8_t const * ) in->pixel )[ 1 ] ) *
			           ( float ) 0.00787402;
			out[ 2 ] = ( float ) 0.00000000;
			out[ 3 ] = ( float ) 1.00000000;
			out += 4;
	...
	case TinyImageFormat_R8G8_SRGB:
		for ( uint32_t w = 0; w < width; ++w )
		{
			out[ 0 ] = ( float ) TinyImageFormat_LookupSRGB(
			    ( ( uint8_t const * ) in->pixel )[ 0 ] );
			out[ 1 ] = ( float ) TinyImageFormat_LookupSRGB(
			    ( ( uint8_t const * ) in->pixel )[ 1 ] );
			out[ 2 ] = ( float ) 0.00000000;
			out[ 3 ] = ( float ) 1.00000000;
			out += 4;
			in->pixel =
	...
	case TinyImageFormat_R16_SNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int16_t const * ) in->pixel ) + 1 );
		}
		return true;
	...
	case TinyImageFormat_R16_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			out[ 0 ] = ( float ) TinyImageFormat_HalfAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 0 ] );
			out[ 1 ] = ( float ) 0.00000000;
			out[ 2 ] = ( float ) 0.00000000;
			out[ 3 ] = ( float ) 1.00000000;
			out += 4;
	...
	case TinyImageFormat_R16_SBFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			out[ 0 ] = ( float ) TinyImageFormat_BFloatAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 0 ] );
			out[ 1 ] = ( float ) 0.00000000;
			out[ 2 ] = ( float ) 0.00000000;
			out[ 3 ] = ( float ) 1.00000000;
	...
	case TinyImageFormat_R8G8B8_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint8_t const * ) in->pixel ) + 3 );
		}
		return true;
	case TinyImageFormat_R8G8B8_SNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int8_t const * ) in->pixel ) + 3 );
		}
		return true;
	...
	case TinyImageFormat_R8G8B8_SRGB:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out[ 1 ] = ( float ) TinyImageFormat_LookupSRGB(
			    ( ( uint8_t const * ) in->pixel )[ 1 ] );
			out[ 2 ] = ( float ) TinyImageFormat_LookupSRGB(
			    ( ( uint8_t const * ) in->pixel )[ 2 ] );
			out[ 3 ] = ( float ) 1.00000000;
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint8_t const * ) in->pixel ) + 3 );
	...
	case TinyImageFormat_R8G8B8A8_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint8_t const * ) in->pixel ) + 4 );
		}
		return true;
	case TinyImageFormat_R8G8B8A8_SNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int8_t const * ) in->pixel ) + 4 );
		}
		return true;
	...
	case TinyImageFormat_R16G16_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint16_t const * ) in->pixel ) + 2 );
		}
		return true;
	case TinyImageFormat_G16R16_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			out[ 1 ] = ( ( float ) ( ( uint16_t const * ) in->pixel )[ 0 ] ) *
			           ( float ) 0.00001526;
			out[ 0 ] = ( ( float ) ( ( uint16_t const * ) in->pixel )[ 1 ] ) *
			           ( float ) 0.00001526;
			out[ 2 ] = ( float ) 0.00000000;
			out[ 3 ] = ( float ) 1.00000000;
			out += 4;
	...
	case TinyImageFormat_R16G16_SNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int16_t const * ) in->pixel ) + 2 );
		}
		return true;
	case TinyImageFormat_G16R16_SNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			out[ 1 ] = ( ( float ) ( ( int16_t const * ) in->pixel )[ 0 ] ) *
			           ( float ) 0.00003052;
			out[ 0 ] = ( ( float ) ( ( int16_t const * ) in->pixel )[ 1 ] ) *
			           ( float ) 0.00003052;
			out[ 2 ] = ( float ) 0.00000000;
			out[ 3 ] = ( float ) 1.00000000;
			out += 4;
	...
	case TinyImageFormat_R16G16_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			out[ 0 ] = ( float ) TinyImageFormat_HalfAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 0 ] );
			out[ 1 ] = ( float ) TinyImageFormat_HalfAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 1 ] );
			out[ 2 ] = ( float ) 0.00000000;
			out[ 3 ] = ( float ) 1.00000000;
			out += 4;
			in->pixel =
	...
	case TinyImageFormat_R16G16_SBFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			out[ 0 ] = ( float ) TinyImageFormat_BFloatAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 0 ] );
			out[ 1 ] = ( float ) TinyImageFormat_BFloatAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 1 ] );
			out[ 2 ] = ( float ) 0.00000000;
			out[ 3 ] = ( float ) 1.00000000;
			out += 4;
	...
	case TinyImageFormat_R32_UINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint32_t const * ) in->pixel ) + 1 );
		}
		return true;
	case TinyImageFormat_R32_SINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int32_t const * ) in->pixel ) + 1 );
		}
		return true;
	case TinyImageFormat_R32_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( float const * ) in->pixel ) + 1 );
		}
		return true;
	...
	case TinyImageFormat_A2R10G10B10_SNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint32_t val = *( ( uint32_t const * ) in->pixel );
			out[ 3 ] =
			    ( ( float ) ( ( val >> 0 ) & 0x3 ) ) * ( ( float ) 1.00000000 );
			out[ 0 ] = ( ( float ) ( ( val >> 2 ) & 0x3ff ) ) *
			           ( ( float ) 0.00195695 );
			out[ 1 ] = ( ( float ) ( ( val >> 12 ) & 0x3ff ) ) *
			           ( ( float ) 0.00195695 );
	...
	case TinyImageFormat_B10G11R11_UFLOAT:
		...
		{
			uint32_t val = *( ( uint32_t const * ) in->pixel );
			out[ 2 ]     = ( float ) TinyImageFormat_UFloat10AsUintToFloat(
                ( val >> 0 ) & 0x3ff );
			out[ 1 ] = ( float ) TinyImageFormat_UFloat11AsUintToFloat(
			    ( val >> 10 ) & 0x7ff );
			out[ 0 ] = ( float ) TinyImageFormat_UFloat11AsUintToFloat(
			    ( val >> 21 ) & 0x7ff );
			out[ 3 ] = ( float ) 1.00000000;
			in->pixel =
			    ( void const * ) ( ( ( uint32_t const * ) in->pixel ) + 1 );
	...
	case TinyImageFormat_E5B9G9R9_UFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			TinyImageFormat_SharedE5B9G9R9UFloatToFloats(
			    *( uint32_t * ) in->pixel,
			    out );
			in->pixel =
			    ( void const * ) ( ( ( uint32_t const * ) in->pixel ) + 1 );
	...
	case TinyImageFormat_R16G16B16_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint16_t const * ) in->pixel ) + 3 );
		}
		return true;
	case TinyImageFormat_R16G16B16_SNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int16_t const * ) in->pixel ) + 3 );
		}
		return true;
	...
	case TinyImageFormat_R16G16B16_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out[ 1 ] = ( float ) TinyImageFormat_HalfAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 1 ] );
			out[ 2 ] = ( float ) TinyImageFormat_HalfAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 2 ] );
			out[ 3 ] = ( float ) 1.00000000;
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint16_t const * ) in->pixel ) + 3 );
	...
	case TinyImageFormat_R16G16B16_SBFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out[ 1 ] = ( float ) TinyImageFormat_BFloatAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 1 ] );
			out[ 2 ] = ( float ) TinyImageFormat_BFloatAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 2 ] );
			out[ 3 ] = ( float ) 1.00000000;
			out += 4;
			in->pixel =
	...
	case TinyImageFormat_R16G16B16A16_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint16_t const * ) in->pixel ) + 4 );
		}
		return true;
	case TinyImageFormat_R16G16B16A16_SNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int16_t const * ) in->pixel ) + 4 );
		}
		return true;
	...
	case TinyImageFormat_R16G16B16A16_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out[ 2 ] = ( float ) TinyImageFormat_HalfAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 2 ] );
			out[ 3 ] = ( float ) TinyImageFormat_HalfAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 3 ] );
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint16_t const * ) in->pixel ) + 4 );
		}
	...
	case TinyImageFormat_R16G16B16A16_SBFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out[ 2 ] = ( float ) TinyImageFormat_BFloatAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 2 ] );
			out[ 3 ] = ( float ) TinyImageFormat_BFloatAsUintToFloat(
			    ( ( ( uint16_t const * ) in->pixel ) )[ 3 ] );
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint16_t const * ) in->pixel ) + 4 );
	...
	case TinyImageFormat_R32G32_UINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint32_t const * ) in->pixel ) + 2 );
		}
		return true;
	case TinyImageFormat_R32G32_SINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int32_t const * ) in->pixel ) + 2 );
		}
		return true;
	case TinyImageFormat_R32G32_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( float const * ) in->pixel ) + 2 );
		}
		return true;
	case TinyImageFormat_R32G32B32_UINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint32_t const * ) in->pixel ) + 3 );
		}
		return true;
	case TinyImageFormat_R32G32B32_SINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int32_t const * ) in->pixel ) + 3 );
		}
		return true;
	case TinyImageFormat_R32G32B32_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( float const * ) in->pixel ) + 3 );
		}
		return true;
	case TinyImageFormat_R32G32B32A32_UINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint32_t const * ) in->pixel ) + 4 );
		}
		return true;
	case TinyImageFormat_R32G32B32A32_SINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int32_t const * ) in->pixel ) + 4 );
		}
		return true;
	case TinyImageFormat_R32G32B32A32_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( float const * ) in->pixel ) + 4 );
		}
		return true;
	case TinyImageFormat_CLUT_P4:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out[ 0 ] =
			    ( float ) ( ( lut[ v0 ] >> 0 ) & 0xFF ) * ( float ) 1.00000000;
			out[ 1 ] =
			    ( float ) ( ( lut[ v0 ] >> 8 ) & 0xFF ) * ( float ) 1.00000000;
			out[ 2 ] =
			    ( float ) ( ( lut[ v0 ] >> 16 ) & 0xFF ) * ( float ) 1.00000000;
			out[ 3 ] =
			    ( float ) ( ( lut[ v0 ] >> 24 ) & 0xFF ) * ( float ) 1.00000000;
			uint32_t v1 = lut[ ( ( val >> 4 ) & 0xf ) ];
			out[ 4 ] =
			    ( float ) ( ( lut[ v1 ] >> 0 ) & 0xFF ) * ( float ) 1.00000000;
			out[ 5 ] =
			    ( float ) ( ( lut[ v1 ] >> 8 ) & 0xFF ) * ( float ) 1.00000000;
			out[ 6 ] =
			    ( float ) ( ( lut[ v1 ] >> 16 ) & 0xFF ) * ( float ) 1.00000000;
			out[ 7 ] =
			    ( float ) ( ( lut[ v1 ] >> 24 ) & 0xFF ) * ( float ) 1.00000000;
			in->pixel =
			    ( void const * ) ( ( ( uint8_t const * ) in->pixel ) + 1 );
		}
		return true;
	case TinyImageFormat_CLUT_P4A4:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out[ 2 ] =
			    ( float ) ( ( lut[ v0 ] >> 16 ) & 0xFF ) * ( float ) 1.00000000;
			out[ 3 ] =
			    ( ( float ) ( ( val >> 4 ) & 0xf ) ) * ( ( float ) 1.00000000 );
			in->pixel =
			    ( void const * ) ( ( ( uint8_t const * ) in->pixel ) + 1 );
		}
		return true;
...
TIF_CONSTEXPR inline bool
TinyImageFormat_CanDecodeLogicalPixelsD( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
...
TIF_CONSTEXPR inline bool
TinyImageFormat_DecodeLogicalPixelsD( TinyImageFormat const        fmt,
                                      TinyImageFormat_DecodeInput *in,
                                      uint32_t const               width,
                                      double                      *out )
{
	...
	case TinyImageFormat_R64_UINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint64_t const * ) in->pixel ) + 1 );
		}
		return true;
	case TinyImageFormat_R64_SINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int64_t const * ) in->pixel ) + 1 );
		}
		return true;
	case TinyImageFormat_R64_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( double const * ) in->pixel ) + 1 );
		}
		return true;
	case TinyImageFormat_R64G64_UINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint64_t const * ) in->pixel ) + 2 );
		}
		return true;
	case TinyImageFormat_R64G64_SINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int64_t const * ) in->pixel ) + 2 );
		}
		return true;
	case TinyImageFormat_R64G64_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( double const * ) in->pixel ) + 2 );
		}
		return true;
	case TinyImageFormat_R64G64B64_UINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint64_t const * ) in->pixel ) + 3 );
		}
		return true;
	case TinyImageFormat_R64G64B64_SINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int64_t const * ) in->pixel ) + 3 );
		}
		return true;
	case TinyImageFormat_R64G64B64_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( double const * ) in->pixel ) + 3 );
		}
		return true;
	case TinyImageFormat_R64G64B64A64_UINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( uint64_t const * ) in->pixel ) + 4 );
		}
		return true;
	case TinyImageFormat_R64G64B64A64_SINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( int64_t const * ) in->pixel ) + 4 );
		}
		return true;
	case TinyImageFormat_R64G64B64A64_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			out += 4;
			in->pixel =
			    ( void const * ) ( ( ( double const * ) in->pixel ) + 4 );
		}
		return true;
	default:
	{
		float outF[ 4 ] = { 0, 0, 0, 0 };
		bool  ret       = true;
...
inline uint8_t
TinyImageFormat_FloatToSRGB( float v )
{
	if ( v < 0.0031308f )
	{
		v *= 12.92f;
...
inline uint16_t
TinyImageFormat_FloatToHalfAsUint( float f_ )
{
	union
	{
		uint16_t u;
	...
	static uint32_t const denorm_magicU = { ( ( 127 - 15 ) + ( 23 - 10 ) + 1 )
		                                    << 23 };
...
inline uint16_t
TinyImageFormat_FloatToBFloatAsUint( float v )
{
	union
	{
		struct
...
inline void
TinyImageFormat_FloatRGBToRGB9E5AsUint32( float const *in, uint32_t *out )
{
	float const r = in[ 0 ];
	float const g = in[ 1 ];
	float const b = in[ 2 ];
...
inline uint16_t
TinyImageFormat_FloatToUFloat6AsUint( float Value )
{
	...
	else
	{
		...
		return (
		    uint16_t ) ( ( ( IValue + 0xFFFFU + ( ( IValue >> 17U ) & 1U ) ) >>
		                   17U ) &
		                 0x3FFU );
	}
}
...
inline uint16_t
TinyImageFormat_FloatToUFloat7AsUint( float Value )
{
	uint32_t IValue = *( ( uint32_t * ) &Value );
	...
	else
	{
		...
		return (
		    uint16_t ) ( ( ( IValue + 0x7FFFU + ( ( IValue >> 16U ) & 1U ) ) >>
		                   16U ) &
		                 0x3FFU );
	}
}
...
inline uint16_t
TinyImageFormat_FloatToUFloat10AsUint( float v )
{
	union
	{
		uint32_t u;
	...
	if ( o.Exponent == 0xFF )
	{
		if ( o.Mantissa != 0 )
		{
			return 0x3e0 | ( ( ( o.u >> 18 ) | ( o.u >> 11 ) | ( o.u >> 6 ) |
			                   ( o.u ) ) &
			                 0x3f );
		}
		else
...
inline uint16_t
TinyImageFormat_FloatToUFloat11AsUint( float v )
{
	union
	{
		uint32_t u;
	...
	if ( o.Exponent == 0xFF )
	{
		if ( o.Mantissa != 0 )
		{
			return 0x7c0 | ( ( ( o.u >> 17 ) | ( o.u >> 11 ) | ( o.u >> 6 ) |
			                   ( o.u ) ) &
			                 0x3f );
		}
		else
...
TIF_CONSTEXPR inline bool
TinyImageFormat_CanEncodeLogicalPixelsF( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
	case TinyImageFormat_R1_UNORM: return true;
...
TIF_CONSTEXPR inline bool
TinyImageFormat_EncodeLogicalPixelsF( TinyImageFormat const         fmt,
                                      float const                  *in,
                                      uint32_t const                width,
                                      TinyImageFormat_EncodeOutput *out )
{
	switch ( fmt )
	{
	case TinyImageFormat_R1_UNORM:
	...
	case TinyImageFormat_R8_SRGB:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			*op0         = 0;
			*op0 |=
			    ( ( uint8_t ) TinyImageFormat_FloatToSRGB( ( float ) in[ 0 ] ) )
			    << 0;
			out->pixel = ( void * ) ( ( ( uint8_t * ) out->pixel ) + 1 );
			in += 4;
		}
	...
	case TinyImageFormat_R4G4B4A4_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint16_t *op0 = ( uint16_t * ) out->pixel;
			*op0          = 0;
	...
	case TinyImageFormat_X4R4G4B4_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint16_t *op1 = ( uint16_t * ) out->pixel;
			*op1          = 0;
	...
	case TinyImageFormat_R8G8_SRGB:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint16_t *op0 = ( uint16_t * ) out->pixel;
			*op0          = 0;
			*op0 |= ( ( uint16_t ) TinyImageFormat_FloatToSRGB(
			            ( float ) in[ 0 ] ) )
			        << 0;
			*op0 |= ( ( uint16_t ) TinyImageFormat_FloatToSRGB(
			            ( float ) in[ 1 ] ) )
	...
	case TinyImageFormat_R16_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint16_t *op0 = ( uint16_t * ) out->pixel;
			*op0          = 0;
			*op0 |= ( ( uint16_t ) TinyImageFormat_FloatToHalfAsUint(
			            ( float ) in[ 0 ] ) )
			        << 0;
			out->pixel = ( void * ) ( ( ( uint16_t * ) out->pixel ) + 1 );
			in += 4;
	...
	case TinyImageFormat_R16_SBFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint16_t *op0 = ( uint16_t * ) out->pixel;
			*op0          = 0;
			*op0 |= ( ( uint16_t ) TinyImageFormat_FloatToBFloatAsUint(
			            ( float ) in[ 0 ] ) )
			        << 0;
			out->pixel = ( void * ) ( ( ( uint16_t * ) out->pixel ) + 1 );
			in += 4;
	...
	case TinyImageFormat_R8G8B8_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			*op0 |= ( ( uint8_t ) ( in[ 0 ] * 255.00f ) & 0xff ) << 0;
			out->pixel   = ( void   *) ( ( ( uint8_t   *) out->pixel ) + 1 );
			uint8_t *op1 = ( uint8_t * ) out->pixel;
			*op1         = 0;
			*op1 |= ( ( uint8_t ) ( in[ 1 ] * 255.00f ) & 0xff ) << 0;
			out->pixel   = ( void   *) ( ( ( uint8_t   *) out->pixel ) + 1 );
			uint8_t *op2 = ( uint8_t * ) out->pixel;
			*op2         = 0;
	...
	case TinyImageFormat_R8G8B8_SRGB:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			*op1         = 0;
			*op1 |=
			    ( ( uint8_t ) TinyImageFormat_FloatToSRGB( ( float ) in[ 1 ] ) )
			    << 0;
			out->pixel   = ( void   *) ( ( ( uint8_t   *) out->pixel ) + 1 );
			uint8_t *op2 = ( uint8_t * ) out->pixel;
			*op2         = 0;
			*op2 |=
			    ( ( uint8_t ) TinyImageFormat_FloatToSRGB( ( float ) in[ 2 ] ) )
			    << 0;
			out->pixel = ( void * ) ( ( ( uint8_t * ) out->pixel ) + 1 );
			in += 4;
		}
	...
	case TinyImageFormat_R8G8B8A8_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint32_t *op0 = ( uint32_t * ) out->pixel;
			*op0          = 0;
	...
	case TinyImageFormat_R8G8B8A8_SRGB:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint32_t *op0 = ( uint32_t * ) out->pixel;
			*op0          = 0;
			*op0 |= ( ( uint32_t ) TinyImageFormat_FloatToSRGB(
			            ( float ) in[ 0 ] ) )
			        << 0;
			*op0 |= ( ( uint32_t ) TinyImageFormat_FloatToSRGB(
			            ( float ) in[ 1 ] ) )
	...
	case TinyImageFormat_R16G16_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint32_t *op0 = ( uint32_t * ) out->pixel;
			*op0          = 0;
			*op0 |= ( ( uint32_t ) TinyImageFormat_FloatToHalfAsUint(
			            ( float ) in[ 0 ] ) )
			        << 0;
			*op0 |= ( ( uint32_t ) TinyImageFormat_FloatToHalfAsUint(
			            ( float ) in[ 1 ] ) )
	...
	case TinyImageFormat_R16G16_SBFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint32_t *op0 = ( uint32_t * ) out->pixel;
			*op0          = 0;
			*op0 |= ( ( uint32_t ) TinyImageFormat_FloatToBFloatAsUint(
			            ( float ) in[ 0 ] ) )
			        << 0;
			*op0 |= ( ( uint32_t ) TinyImageFormat_FloatToBFloatAsUint(
			            ( float ) in[ 1 ] ) )
	...
	case TinyImageFormat_B10G11R11_UFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint32_t *op0 = ( uint32_t * ) out->pixel;
			*op0          = 0;
			*op0 |= ( ( uint32_t ) TinyImageFormat_FloatToUFloat10AsUint(
			            ( float ) in[ 2 ] ) )
			        << 0;
			*op0 |= ( ( uint32_t ) TinyImageFormat_FloatToUFloat11AsUint(
			            ( float ) in[ 1 ] ) )
			        << 10;
			*op0 |= ( ( uint32_t ) TinyImageFormat_FloatToUFloat11AsUint(
			            ( float ) in[ 0 ] ) )
	...
	case TinyImageFormat_E5B9G9R9_UFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			TinyImageFormat_FloatRGBToRGB9E5AsUint32(
			    ( float const * ) in,
			    ( uint32_t * ) out->pixel );
			out->pixel = ( void * ) ( ( ( uint32_t * ) out->pixel ) + 1 );
			in += 4;
	...
	case TinyImageFormat_R16G16B16_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			*op1 |= ( ( uint16_t ) ( in[ 1 ] * 65535.00f ) & 0xffff ) << 0;
			out->pixel    = ( void    *) ( ( ( uint16_t    *) out->pixel ) + 1 );
			uint16_t *op2 = ( uint16_t * ) out->pixel;
			*op2          = 0;
	...
	case TinyImageFormat_R16G16B16_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			*op0 |= ( ( uint16_t ) TinyImageFormat_FloatToHalfAsUint(
			...
			uint16_t *op1 = ( uint16_t * ) out->pixel;
			*op1          = 0;
			*op1 |= ( ( uint16_t ) TinyImageFormat_FloatToHalfAsUint(
			            ( float ) in[ 1 ] ) )
			        << 0;
			out->pixel    = ( void    *) ( ( ( uint16_t    *) out->pixel ) + 1 );
			uint16_t *op2 = ( uint16_t * ) out->pixel;
			*op2          = 0;
			*op2 |= ( ( uint16_t ) TinyImageFormat_FloatToHalfAsUint(
			            ( float ) in[ 2 ] ) )
			        << 0;
			out->pixel = ( void * ) ( ( ( uint16_t * ) out->pixel ) + 1 );
			in += 4;
	...
	case TinyImageFormat_R16G16B16_SBFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			*op0 |= ( ( uint16_t ) TinyImageFormat_FloatToBFloatAsUint(
			...
			uint16_t *op1 = ( uint16_t * ) out->pixel;
			*op1          = 0;
			*op1 |= ( ( uint16_t ) TinyImageFormat_FloatToBFloatAsUint(
			            ( float ) in[ 1 ] ) )
			        << 0;
			out->pixel    = ( void    *) ( ( ( uint16_t    *) out->pixel ) + 1 );
			uint16_t *op2 = ( uint16_t * ) out->pixel;
			*op2          = 0;
			*op2 |= ( ( uint16_t ) TinyImageFormat_FloatToBFloatAsUint(
			            ( float ) in[ 2 ] ) )
			        << 0;
			out->pixel = ( void * ) ( ( ( uint16_t * ) out->pixel ) + 1 );
			in += 4;
	...
	case TinyImageFormat_R16G16B16A16_UNORM:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint64_t *op0 = ( uint64_t * ) out->pixel;
			*op0          = 0;
	...
	case TinyImageFormat_R16G16B16A16_SFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint64_t *op0 = ( uint64_t * ) out->pixel;
			*op0          = 0;
			*op0 |= ( ( uint64_t ) TinyImageFormat_FloatToHalfAsUint(
			            ( float ) in[ 0 ] ) )
			        << 0;
			*op0 |= ( ( uint64_t ) TinyImageFormat_FloatToHalfAsUint(
			            ( float ) in[ 1 ] ) )
	...
	case TinyImageFormat_R16G16B16A16_SBFLOAT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			uint64_t *op0 = ( uint64_t * ) out->pixel;
			*op0          = 0;
			*op0 |= ( ( uint64_t ) TinyImageFormat_FloatToBFloatAsUint(
			            ( float ) in[ 0 ] ) )
			        << 0;
			*op0 |= ( ( uint64_t ) TinyImageFormat_FloatToBFloatAsUint(
			            ( float ) in[ 1 ] ) )
	...
	case TinyImageFormat_R32G32B32_UINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			*op0 |= ( ( ( uint32_t ) in[ 0 ] ) & 0xffffffff ) << 0;
			out->pixel    = ( void    *) ( ( ( uint32_t    *) out->pixel ) + 1 );
			uint32_t *op1 = ( uint32_t * ) out->pixel;
			*op1          = 0;
			*op1 |= ( ( ( uint32_t ) in[ 1 ] ) & 0xffffffff ) << 0;
			out->pixel    = ( void    *) ( ( ( uint32_t    *) out->pixel ) + 1 );
			uint32_t *op2 = ( uint32_t * ) out->pixel;
			*op2          = 0;
	...
	case TinyImageFormat_R32G32B32A32_UINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			*op0 |= ( ( ( uint64_t ) in[ 1 ] ) & 0xffffffff ) << 32;
			out->pixel    = ( void    *) ( ( ( uint64_t    *) out->pixel ) + 1 );
			uint64_t *op2 = ( uint64_t * ) out->pixel;
			*op2          = 0;
...
TIF_CONSTEXPR inline bool
TinyImageFormat_CanEncodeLogicalPixelsD( TinyImageFormat const fmt )
{
	switch ( fmt )
	{
	case TinyImageFormat_R64_UINT: return true;
...
TIF_CONSTEXPR inline bool
TinyImageFormat_EncodeLogicalPixelsD( TinyImageFormat const         fmt,
                                      double const                 *in,
                                      uint32_t const                width,
                                      TinyImageFormat_EncodeOutput *out )
{
	...
	case TinyImageFormat_R64G64_UINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			*op0 |= ( ( ( uint64_t ) in[ 0 ] ) & 0x0 ) << 0;
			out->pixel    = ( void    *) ( ( ( uint64_t    *) out->pixel ) + 1 );
			uint64_t *op1 = ( uint64_t * ) out->pixel;
			*op1          = 0;
	...
	case TinyImageFormat_R64G64B64A64_UINT:
		for ( uint32_t w = 0; w < width; ++w )
		{
			...
			*op2 |= ( ( ( uint64_t ) in[ 2 ] ) & 0x0 ) << 0;
			out->pixel    = ( void    *) ( ( ( uint64_t    *) out->pixel ) + 1 );
			uint64_t *op3 = ( uint64_t * ) out->pixel;
			*op3          = 0;
...
inline TinyImageFormat
TinyImageFormat_FromVkFormat( TinyImageFormat_VkFormat fmt )
{
	switch ( fmt )
	{
...
inline TinyImageFormat_VkFormat
TinyImageFormat_ToVkFormat( TinyImageFormat fmt )
{
	switch ( fmt )
	{
...
inline TinyImageFormat
TinyImageFormat_FromDXGI_FORMAT( TinyImageFormat_DXGI_FORMAT fmt )
{
	switch ( fmt )
	{
...
inline TinyImageFormat_DXGI_FORMAT
TinyImageFormat_ToDXGI_FORMAT( TinyImageFormat fmt )
{
	switch ( fmt )
	{
...
inline TinyImageFormat_DXGI_FORMAT
TinyImageFormat_DXGI_FORMATToTypeless( TinyImageFormat_DXGI_FORMAT fmt )
{
	switch ( fmt )
	{
	case TIF_DXGI_FORMAT_R32G32B32A32_FLOAT:
...
inline TinyImageFormat
TinyImageFormat_FromMTLPixelFormat( TinyImageFormat_MTLPixelFormat fmt )
{
	switch ( fmt )
	{
...
inline bool
TinyImageFormat_MTLPixelFormatOnMac( TinyImageFormat_MTLPixelFormat fmt )
{
	switch ( fmt )
	{
	...
	case TIF_MTLPixelFormatDepth32Float_Stencil8:
	case TIF_MTLPixelFormatX32_Stencil8:
	case TIF_MTLPixelFormatX24_Stencil8: return true;
...
inline bool
TinyImageFormat_MTLPixelFormatOnIOs( TinyImageFormat_MTLPixelFormat fmt )
{
	switch ( fmt )
	{
	case TIF_MTLPixelFormatA8Unorm:
	...
	case TIF_MTLPixelFormatBGR5A1Unorm:
	case TIF_MTLPixelFormatR8Unorm_sRGB:
	case TIF_MTLPixelFormatRG8Unorm_sRGB: return true;
