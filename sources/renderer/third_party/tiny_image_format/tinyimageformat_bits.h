...
typedef enum TinyImageFormat_Bits
{
	...
	TinyImageFormat_NAMESPACE_MASK =
	    ( 1 << TinyImageFormat_NAMESPACE_REQUIRED_BITS ) - 1,
	...
	TinyImageFormat_PACK_SPECIAL_SHIFT =
	    ( TinyImageFormat_NAMESPACE_REQUIRED_BITS ),
	TinyImageFormat_PACK_BITS_SHIFT =
	    ( TinyImageFormat_PACK_SPECIAL_REQUIRED_BITS +
	      TinyImageFormat_PACK_SPECIAL_SHIFT ),
	TinyImageFormat_PACK_SWIZZLE_SHIFT =
	    ( ( TinyImageFormat_PACK_BITS_REQUIRED_BITS *
	        TinyImageFormat_PACK_NUM_CHANNELS ) +
	      TinyImageFormat_PACK_BITS_SHIFT ),
	TinyImageFormat_PACK_TYPE_SHIFT =
	    ( ( TinyImageFormat_PACK_SWIZZLE_REQUIRED_BITS *
	        TinyImageFormat_PACK_NUM_CHANNELS ) +
	      TinyImageFormat_PACK_SWIZZLE_SHIFT ),
	...
	TinyImageFormat_DEPTH_STENCIL_TOTAL_SIZE_SHIFT =
	    ( TinyImageFormat_NAMESPACE_REQUIRED_BITS ),
	TinyImageFormat_DEPTH_STENCIL_BITS_SHIFT =
	    ( ( TinyImageFormat_DEPTH_STENCIL_TOTAL_SIZE_REQUIRED_BITS ) +
	      TinyImageFormat_DEPTH_STENCIL_TOTAL_SIZE_SHIFT ),
	TinyImageFormat_DEPTH_STENCIL_SWIZZLE_SHIFT =
	    ( ( TinyImageFormat_DEPTH_STENCIL_BITS_REQUIRED_BITS *
	        TinyImageFormat_DEPTH_STENCIL_NUM_CHANNELS ) +
	      TinyImageFormat_DEPTH_STENCIL_BITS_SHIFT ),
	TinyImageFormat_DEPTH_STENCIL_TYPE_SHIFT =
	    ( ( TinyImageFormat_DEPTH_STENCIL_SWIZZLE_REQUIRED_BITS *
	        TinyImageFormat_DEPTH_STENCIL_NUM_CHANNELS ) +
	      TinyImageFormat_DEPTH_STENCIL_SWIZZLE_SHIFT ),
	...
	TinyImageFormat_DXTC_ALPHA_SHIFT =
	    ( TinyImageFormat_NAMESPACE_REQUIRED_BITS ),
	TinyImageFormat_DXTC_TYPE_SHIFT =
	    ( TinyImageFormat_DXTC_ALPHA_REQUIRED_BITS +
	      TinyImageFormat_DXTC_ALPHA_SHIFT ),
	TinyImageFormat_DXTC_BLOCKBYTES_SHIFT =
	    ( TinyImageFormat_DXTC_TYPE_REQUIRED_BITS +
	      TinyImageFormat_DXTC_TYPE_SHIFT ),
	TinyImageFormat_DXTC_CHANNELCOUNT_SHIFT =
	    ( TinyImageFormat_DXTC_BLOCKBYTES_REQUIRED_BITS +
	      TinyImageFormat_DXTC_BLOCKBYTES_SHIFT ),
	...
	TinyImageFormat_PVRTC_VERSION_SHIFT =
	    ( TinyImageFormat_NAMESPACE_REQUIRED_BITS ),
	TinyImageFormat_PVRTC_BITS_SHIFT =
	    ( TinyImageFormat_PVRTC_VERSION_REQUIRED_BITS +
	      TinyImageFormat_PVRTC_VERSION_SHIFT ),
	TinyImageFormat_PVRTC_TYPE_SHIFT =
	...
	TinyImageFormat_ETC_BITS_SHIFT =
	    ( TinyImageFormat_NAMESPACE_REQUIRED_BITS ),
	TinyImageFormat_ETC_ALPHA_SHIFT = ( TinyImageFormat_ETC_BITS_REQUIRED_BITS +
	                                    TinyImageFormat_ETC_BITS_SHIFT ),
	TinyImageFormat_ETC_TYPE_SHIFT = ( TinyImageFormat_ETC_ALPHA_REQUIRED_BITS +
	                                   TinyImageFormat_ETC_ALPHA_SHIFT ),
	TinyImageFormat_ETC_CHANNELCOUNT_SHIFT =
	    ( TinyImageFormat_ETC_TYPE_REQUIRED_BITS +
	      TinyImageFormat_ETC_TYPE_SHIFT ),
	...
	TinyImageFormat_ASTC_TYPE_SHIFT =
	    ( ( TinyImageFormat_ASTC_SIZE_REQUIRED_BITS *
	        TinyImageFormat_ASTC_NUM_DIMS ) +
	      TinyImageFormat_ASTC_SIZE_SHIFT ),
	...
	TinyImageFormat_CLUT_BLOCKSIZE_SHIFT =
	    TinyImageFormat_NAMESPACE_REQUIRED_BITS,
	TinyImageFormat_CLUT_BITS_SHIFT =
	    TinyImageFormat_CLUT_BLOCKSIZE_REQUIRED_BITS +
	    TinyImageFormat_CLUT_BLOCKSIZE_SHIFT,
	TinyImageFormat_CLUT_TYPE_SHIFT =
	    ( ( TinyImageFormat_CLUT_BITS_REQUIRED_BITS *
	        TinyImageFormat_CLUT_NUM_CHANNELS ) +
	      TinyImageFormat_CLUT_BITS_SHIFT ),
