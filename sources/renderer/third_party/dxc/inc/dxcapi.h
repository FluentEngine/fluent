...
/// </summary>
/// <param name="rclsid">
/// The CLSID associated with the data and code that will be used to create the
/// object.
/// </param>
/// <param name="riid">
...
extern "C" DXC_API_IMPORT HRESULT __stdcall DxcCreateInstance(
    _In_ REFCLSID rclsid,
    _In_ REFIID   riid,
    _Out_ LPVOID *ppv );

extern "C" DXC_API_IMPORT HRESULT __stdcall DxcCreateInstance2(
...
// This flag indicates that the shader hash was computed taking into account
// source information (-Zss)
...
CROSS_PLATFORM_UUIDOF( IDxcBlobEncoding,
                       "7241d424-2646-4191-97c0-98e96e42fc68" )
struct IDxcBlobEncoding : public IDxcBlob
{
public:
	virtual HRESULT STDMETHODCALLTYPE
	GetEncoding( _Out_ BOOL *pKnown, _Out_ UINT32 *pCodePage ) = 0;
};
...
// GetStringLength() will return the length in characters, excluding the
// null-terminator Name strings will use IDxcBlobUtf16, while other string
// output blobs, such as errors/warnings, preprocessed HLSL, or other text will
// be based on the -encoding option.
...
{
	virtual HRESULT STDMETHODCALLTYPE
	LoadSource( _In_z_ LPCWSTR pFilename, // Candidate filename.
	            _COM_Outptr_result_maybenull_ IDxcBlob *
	                *ppIncludeSource // Resultant source object for included
	                                 // file, nullptr if not found.
	            ) = 0;
};
...
CROSS_PLATFORM_UUIDOF( IDxcCompilerArgs,
...
struct IDxcCompilerArgs : public IUnknown
{
	...
	virtual LPCWSTR *STDMETHODCALLTYPE
	GetArguments() = 0;
	virtual UINT32 STDMETHODCALLTYPE
	GetCount() = 0;
	...
	virtual HRESULT STDMETHODCALLTYPE
	AddDefines( _In_count_( defineCount )
...
{
	virtual HRESULT STDMETHODCALLTYPE
	SetMalloc( _In_opt_ IMalloc *pMalloc ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	CreateBlobFromBlob( _In_ IDxcBlob          *pBlob,
	                    UINT32                  offset,
	                    UINT32                  length,
	                    _COM_Outptr_ IDxcBlob **ppResult ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	CreateBlobFromFile( _In_z_ LPCWSTR                  pFileName,
	...
	virtual HRESULT STDMETHODCALLTYPE
	CreateStreamFromBlobReadOnly( _In_ IDxcBlob         *pBlob,
	                              _COM_Outptr_ IStream **ppStream ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetBlobAsUtf8( _In_ IDxcBlob                  *pBlob,
	               _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetBlobAsUtf16( _In_ IDxcBlob                  *pBlob,
	                _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding ) = 0;
};
...
{
	virtual HRESULT STDMETHODCALLTYPE
	GetStatus( _Out_ HRESULT *pStatus ) = 0;
	...
	virtual HRESULT STDMETHODCALLTYPE
	GetErrorBuffer(
	    _COM_Outptr_result_maybenull_ IDxcBlobEncoding **ppErrors ) = 0;
};
...
public:
	...
	// use.
	virtual HRESULT STDMETHODCALLTYPE
	Link( _In_opt_ LPCWSTR pEntryName,     // Entry point name
...
struct IDxcUtils : public IUnknown
{
	...
	virtual HRESULT STDMETHODCALLTYPE
	CreateBlobFromPinned( _In_bytecount_( size ) LPCVOID  pData,
	                      UINT32                          size,
	                      UINT32                          codePage,
	                      _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding ) = 0;

	// Create blob, taking ownership of memory allocated with supplied
	// allocator. (was: CreateBlobWithEncodingOnMalloc)
	virtual HRESULT STDMETHODCALLTYPE
	MoveToBlob( _In_bytecount_( size ) LPCVOID  pData,
	            IMalloc	                    *pIMalloc,
	            UINT32                          size,
	            UINT32                          codePage,
	            _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding ) = 0;
	...
	virtual HRESULT STDMETHODCALLTYPE
	CreateBlob( _In_bytecount_( size ) LPCVOID  pData,
	            UINT32                          size,
	            UINT32                          codePage,
	            _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding ) = 0;
	...
	virtual HRESULT STDMETHODCALLTYPE
	LoadFile( _In_z_ LPCWSTR                  pFileName,
	          _In_opt_ UINT32                *pCodePage,
	          _COM_Outptr_ IDxcBlobEncoding **pBlobEncoding ) = 0;

	virtual HRESULT STDMETHODCALLTYPE
	CreateReadOnlyStreamFromBlob( _In_ IDxcBlob         *pBlob,
	                              _COM_Outptr_ IStream **ppStream ) = 0;
	...
	virtual HRESULT STDMETHODCALLTYPE
	GetBlobAsUtf8( _In_ IDxcBlob              *pBlob,
	               _COM_Outptr_ IDxcBlobUtf8 **pBlobEncoding ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetBlobAsUtf16( _In_ IDxcBlob               *pBlob,
	                _COM_Outptr_ IDxcBlobUtf16 **pBlobEncoding ) = 0;

	virtual HRESULT STDMETHODCALLTYPE
	GetDxilContainerPart( _In_ const DxcBuffer                *pShader,
	                      _In_ UINT32                          DxcPart,
	...
	// DXC_PART_REFLECTION_DATA. TBD: Require part header for RDAT?  (leaning
	// towards yes)
	virtual HRESULT STDMETHODCALLTYPE
	CreateReflection( _In_ const DxcBuffer *pData,
	                  REFIID                iid,
	                  void                **ppvReflection ) = 0;
	...
	virtual HRESULT STDMETHODCALLTYPE
	GetPDBContents( _In_ IDxcBlob          *pPDBBlob,
...
typedef enum DXC_OUT_KIND
{
	...
	DXC_OUT_HLSL =
	    6, // IDxcBlobUtf8 or IDxcBlobUtf16 - from Preprocessor or Rewriter
	DXC_OUT_TEXT = 7, // IDxcBlobUtf8 or IDxcBlobUtf16 - other text, such as
	                  // -ast-dump or -Odump
...
struct IDxcResult : public IDxcOperationResult
{
	...
	HasOutput( _In_ DXC_OUT_KIND dxcOutKind ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetOutput( _In_ DXC_OUT_KIND                        dxcOutKind,
	           _In_ REFIID                              iid,
	...
	virtual UINT32
	GetNumOutputs() = 0;
	virtual DXC_OUT_KIND
	GetOutputByIndex( UINT32 Index ) = 0;
	virtual DXC_OUT_KIND
	PrimaryOutput() = 0;
};
...
CROSS_PLATFORM_UUIDOF( IDxcExtraOutputs,
...
struct IDxcCompiler3 : public IUnknown
{
	...
	virtual HRESULT STDMETHODCALLTYPE
	Compile( _In_ const DxcBuffer *pSource, // Source text to compile
	         _In_opt_count_( argCount )
	             LPCWSTR *pArguments, // Array of pointers to arguments
	         _In_ UINT32  argCount,   // Number of arguments
	         _In_opt_ IDxcIncludeHandler
	...
	// Disassemble a program.
	virtual HRESULT STDMETHODCALLTYPE
	Disassemble( _In_ const DxcBuffer *pObject, // Program to disassemble: dxil
	                                            // container or bitcode.
	             _In_ REFIID   riid,
	             _Out_ LPVOID *ppResult // IDxcResult: status, disassembly text,
	                                    // and errors
	             ) = 0;
};
...
struct IDxcValidator : public IUnknown
{
	// Validate a shader.
	virtual HRESULT STDMETHODCALLTYPE
	Validate( _In_ IDxcBlob *pShader, // Shader to validate.
...
struct IDxcContainerBuilder : public IUnknown
{
	virtual HRESULT STDMETHODCALLTYPE
	Load( _In_ IDxcBlob
	          *pDxilContainerHeader ) = 0; // Loads DxilContainer to the builder
	virtual HRESULT STDMETHODCALLTYPE
	AddPart( _In_ UINT32    fourCC,
	         _In_ IDxcBlob *pSource ) = 0; // Part to add to the container
	virtual HRESULT STDMETHODCALLTYPE
	RemovePart( _In_ UINT32 fourCC ) = 0; // Remove the part with fourCC
	virtual HRESULT STDMETHODCALLTYPE
	SerializeContainer( _Out_ IDxcOperationResult *
	                        *ppResult ) = 0; // Builds a container of the given
...
{
	virtual HRESULT STDMETHODCALLTYPE
	Load( _In_ IDxcBlob *pContainer ) = 0; // Container to load.
	virtual HRESULT STDMETHODCALLTYPE
	GetPartCount( _Out_ UINT32 *pResult ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetPartKind( UINT32 idx, _Out_ UINT32 *pResult ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetPartContent( UINT32 idx, _COM_Outptr_ IDxcBlob **ppResult ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	FindFirstPartKind( UINT32 kind, _Out_ UINT32 *pResult ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetPartReflection( UINT32 idx, REFIID iid, void **ppvObject ) = 0;
};

CROSS_PLATFORM_UUIDOF( IDxcOptimizerPass,
...
struct IDxcOptimizerPass : public IUnknown
{
	...
	virtual HRESULT STDMETHODCALLTYPE
	GetOptionArgCount( _Out_ UINT32 *pCount ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetOptionArgName( UINT32 argIndex, _COM_Outptr_ LPWSTR *ppResult ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetOptionArgDescription( UINT32               argIndex,
	                         _COM_Outptr_ LPWSTR *ppResult ) = 0;
};
...
struct IDxcOptimizer : public IUnknown
{
	...
	virtual HRESULT STDMETHODCALLTYPE
	GetAvailablePass( UINT32                           index,
	                  _COM_Outptr_ IDxcOptimizerPass **ppResult ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	RunOptimizer( IDxcBlob	                       *pBlob,
...
{
	virtual HRESULT STDMETHODCALLTYPE
	GetVersion( _Out_ UINT32 *pMajor, _Out_ UINT32 *pMinor ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetFlags( _Out_ UINT32 *pFlags ) = 0;
};

CROSS_PLATFORM_UUIDOF( IDxcVersionInfo2,
...
CROSS_PLATFORM_UUIDOF( IDxcVersionInfo3,
...
{
	virtual HRESULT STDMETHODCALLTYPE
	Load( _In_ IDxcBlob *pPdbOrDxil ) = 0;

	virtual HRESULT STDMETHODCALLTYPE
	GetSourceCount( _Out_ UINT32 *pCount ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetSource( _In_ UINT32                     uIndex,
	           _COM_Outptr_ IDxcBlobEncoding **ppResult ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetSourceName( _In_ UINT32 uIndex, _Outptr_result_z_ BSTR *pResult ) = 0;

	virtual HRESULT STDMETHODCALLTYPE
	GetFlagCount( _Out_ UINT32 *pCount ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetFlag( _In_ UINT32 uIndex, _Outptr_result_z_ BSTR *pResult ) = 0;

	virtual HRESULT STDMETHODCALLTYPE
	GetArgCount( _Out_ UINT32 *pCount ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetArg( _In_ UINT32 uIndex, _Outptr_result_z_ BSTR *pResult ) = 0;

	virtual HRESULT STDMETHODCALLTYPE
	GetArgPairCount( _Out_ UINT32 *pCount ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	GetArgPair( _In_ UINT32             uIndex,
	            _Outptr_result_z_ BSTR *pName,
	            _Outptr_result_z_ BSTR *pValue ) = 0;

	virtual HRESULT STDMETHODCALLTYPE
	GetDefineCount( _Out_ UINT32 *pCount ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
	...
	virtual HRESULT STDMETHODCALLTYPE
	OverrideArgs( _In_ DxcArgPair *pArgPairs, UINT32 uNumArgPairs ) = 0;
	virtual HRESULT STDMETHODCALLTYPE
