...
//	memcpy( loaded_data, image_data->m_mem, image_data->m_memSlicePitch );
//	*data = loaded_data;
//	return image_info;
//}
...
//	image_info.depth        = 1;
//	image_info.format       = FT_FORMAT_R8G8B8A8_UNORM;
...
// ImageInfo
// read_image_data( const std::string& filename, b32 flip, u64* size, void**
// data )
//{
