...
void on_init()
{
    ...
    camera_ubo.projection =
        create_perspective_matrix( radians( 45.0f ),
                                   ...
                                   0.1f,
                                   100.f );
    camera_ubo.view = create_look_at_matrix( Vector3( 0.0f, 0.0, 2.0f ),
                                             Vector3( 0.0, 0.0, -1.0 ),
                                             Vector3( 0.0, 1.0, 0.0 ) );
    ...
    descriptor_writes[ 2 ].descriptor_image_descs =
        descriptor_image_descs.data();
